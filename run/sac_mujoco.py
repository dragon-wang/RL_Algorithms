...
if __name__ == '__main__':
    ...
    policy_optimizer = torch.optim.Adam(policy_net.parameters(), lr=3e-4)
    q_optimizer1 = torch.optim.Adam(q_net1.parameters(), lr=3e-4)
    q_optimizer2 = torch.optim.Adam(q_net2.parameters(), lr=3e-4)
